...
const Footer = () => {
  ...
  <nav>
    ...
    <a className="link link-hover">Stage Decoration</a> 
    <a className="link link-hover">Ceiling Decoration</a> 
    <a className="link link-hover">Car Decoration</a> 
    <a className="link link-hover">Entrance Decoration</a>
    <a className="link link-hover">Holud Stage Decoration</a>
  </nav> 
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-pink-100 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Wedding Planner Industries Ltd. <br/>Providing reliable tech since 2023</p>
  </aside> 
